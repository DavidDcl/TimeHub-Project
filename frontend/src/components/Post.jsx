        ...
        <>
          <div className='flex flex-col bg-neutral'>
            <div className='flex items-center gap-2 ml-3 my-2'>
              <img src='/2.png' alt='Cleopatre' className='h-10 w-10' />
              <p className='dark:text-base-100'>zfznfzenfmzalfnmzalnfmzaln</p>
            </div>
          </div>
          {coms &&
            coms
          ...
          >
            <input
              ...
              className='w-1/2 h-8 bg-base-100 ml-3 my-1 border-2 border-primary rounded-lg'
            />
